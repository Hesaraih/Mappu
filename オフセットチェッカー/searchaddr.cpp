...
#pragma region FFXI小道具
	...
	g_Offset.Sender = GetOffsetAddress(hProcess, dwDllAddress, constSenderPattern); //送り主
	...
	g_Offset.SendTos = GetOffsetAddress(hProcess, dwDllAddress, constSendTosPattern); //送り先
